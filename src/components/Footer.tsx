...
const SocialIcon = ({ name }: { name: string }) => {
  switch (name) {
    ...
    case "TikTok":
      return <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"><path d="M12.536 6.444a4.49 4.49 0 00-.011-.183 3.543 3.543 0 00-3.539-3.415H6.2v17.408a3.545 3.545 0 103.545 3.545v-6.918a7.077 7.077 0 014.288 2.05A7.042 7.042 0 0116.084 24h2.792a9.78 9.78 0 00-1.862-5.462 9.71 9.71 0 00-4.478-3.544v-3.328a7.043 7.043 0 012.333.393 7.082 7.082 0 013.31 2.203V11.21a3.544 3.544 0 00-3.543-3.542h-.001V6.444zM17.818 0l-.001 4.727a4.673 4.673 0 00-2.818-1.042V0h2.819z" /></svg>;
    case "Twitter":
