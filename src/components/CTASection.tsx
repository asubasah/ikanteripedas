    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h2 className="mx-auto max-w-3xl text-3xl font-extrabold text-white sm:text-5xl tracking-tight leading-tight">
          Butuh Cutting & Bending <br /><span className="text-maroon-600">Presisi Hari Ini?</span>
        </h2>
        <p className="mx-auto mt-8 max-w-2xl text-lg text-text-muted leading-relaxed">
          Kirim kebutuhan Anda ke MK Metal Indo dan kami bantu arahkan proses yang paling sesuai. Mulai diskusi sekarang via WhatsApp.
        </p>
